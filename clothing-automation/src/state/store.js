...
// (o workflow commita as mudanças de volta ao repositório) e para o painel estático
// conseguir ler/escrever via API do GitHub.
...
export const settings = () =>
  readJson(join(DATA, 'settings.json'), {
    mode: 'approval',
    postsPerDay: 3,
    pricing: { spreadPercent: 30, rounding: 'psychological' },
    preferences: {},
  });
